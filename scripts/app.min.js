...
$(document).ready(() => {
  ...
  var getVersionDiv = function getVersionDiv() {
    ...
    return "<select id=\"sdk-version\" class=\"sdk-option\" disabled>".concat(options.join(), "</select>");
  };
  ...
  var getPathname = function getPathname() {
    ...
    tmpPathname && tmpPathname[2] ? result.push(tmpPathname[2]) : result.push('1.5.0');
  ...
  var changeAPIPage = function changeAPIPage(pathname) {
    ...
    var path = pathname[2];
    var href = "/".concat(lang, "/").concat(version, "/").concat(path);
    if (oldLang !== lang || oldVersion !== version) window.location.href = href;
  };
