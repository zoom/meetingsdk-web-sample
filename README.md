...
```
npm install @zoomus/websdk@2.1.0
```

Please note, 2.1.0 was released with two ways to include the source, the normal way and the npm way. For npm, you need babel and webpack.
...
See the sample web app (CDN version) for how to update 2.1.0
