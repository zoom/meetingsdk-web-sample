...
Please notice, 1.6.0 release with two ways, the normal way and npm way(need babel and webpack).
...
```
Go to see sample web app (CDN version) how to update 1.3.5 for 1.6.0
