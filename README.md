...
```
npm install @zoomus/websdk@1.7.9
```
...
```
Please notice, 1.7.9 release with two ways, the normal way and npm way(need babel and webpack).
...
```
Go to see sample web app (CDN version) how to update 1.7.9
