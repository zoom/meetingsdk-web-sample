...
document.getElementById('display_name').value =
  'Local#' + ZoomMtg.getWebSDKVersion()[0] + testTool.detectOS() + '#' + testTool.getBrowserInfo();
...
window.copyJoinLink = async function () {
  ...
  meetingConfig.signature = signature;
  const joinUrl =
    testTool.getCurrentDomain() + '/meeting.html?' + testTool.serialize(meetingConfig);
