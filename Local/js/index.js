...
// if (!china) ZoomMtg.setZoomJSLib('https://source.zoom.us/2.16.0/lib', '/av'); // CDN version default
// else ZoomMtg.setZoomJSLib('https://jssdk.zoomus.cn/2.16.0/lib', '/av'); // china cdn option
